...
THe AIC for the ARMA and Random Walk is 563 & 566 respectively so using AIC we marginally choose the ARMA model over the random walk. Using BIC we see they are almost identical, 574 and 574.2. Using a likelihood ratio test of $2 (LL(\theta) - LL(\hat \theta_r) )$
